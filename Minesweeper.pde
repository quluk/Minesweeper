...
{
    {
     ...
     buttons[i][3].setLabel("Y");
   buttons[i][4].setLabel("O");
   buttons[i][5].setLabel("U");
   buttons[i][6].setLabel(" ");
   buttons[i][7].setLabel("S");
   buttons[i][8].setLabel("U");
   buttons[i][9].setLabel("C");
   buttons[i][10].setLabel("K");
   buttons[i][11].setLabel("!");
   buttons[i][12].setLabel("!");
   buttons[i][13].setLabel("!");
   buttons[i][14].setLabel("!");
}
